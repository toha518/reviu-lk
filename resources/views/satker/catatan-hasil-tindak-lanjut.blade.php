...
<h1 class="mb-4 text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-5xl dark:text-white">Laporan Tindak Lanjut</h1>

<a href="https://docs.google.com/document/d/1AUaj67WyoNCgvUvPVZe69XJ74-AkwfW8/export?format=doc">
...
<a href="https://docs.google.com/document/d/1AUaj67WyoNCgvUvPVZe69XJ74-AkwfW8/preview" target="_blank" rel="noopener noreferrer">
...
<iframe src="https://docs.google.com/document/d/e/2PACX-1vQjE8X_6ilSdQXn3JNHgdFAgScqz7s_lLZxnq5FB47CU02UfiXBGAZ6edFmUQSrww/pub?embedded=true" class="aspect-square w-full max-h-72"></iframe>


{{-- Catatan Tindak Lanjut --}}

<h1 class="mt-6 mb-4 text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-5xl dark:text-white">Catatan Tindak Lanjut</h1>
...
class="aspect-square w-full max-h-72"></iframe>

     ...
     <ul class="space-y-2">
      {{-- Menu Home --}}
        ...
        <li> 
         ...
         ">
               <li>
                  <a href="/prosedur-analitis" class="flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 group text-gray-900 dark:text-white {{ ($title==="Prosedur Analitis") ? 'bg-gray-100 dark:bg-gray-700' :' hover:bg-gray-100 dark:hover:bg-gray-700' }} ">Isi Prosedur Analitis</a>
               </li>
               <li>

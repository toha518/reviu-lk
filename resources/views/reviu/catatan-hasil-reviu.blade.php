...
<iframe src="https://docs.google.com/document/d/e/2PACX-1vRhNULap447-KKpnG1IMR3cGL8y21MHwXjYNrvS5Ao7DvZ9cFcYWTI8R0506_xeLQ/pub?embedded=true" class="aspect-square w-full max-h-72"></iframe>

{{-- Catatan Hasil Reviu --}}

<h1 class="mt-6 mb-4 text-xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-5xl dark:text-white">Catatan Hasil Reviu</h1>

<a href="https://docs.google.com/document/d/1gP79xWsDPNpIN6cS2nVyRg1nkMXXU1ez/export?format=doc">
    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Unduh</button>
</a>

<a href="https://docs.google.com/document/d/1gP79xWsDPNpIN6cS2nVyRg1nkMXXU1ez/preview" target="_blank" rel="noopener noreferrer">
    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Lihat</button>
</a>

<iframe src="https://docs.google.com/document/d/e/2PACX-1vT5CF0qVDj06tSx7JPV6s-8erYTnhhCyoEO7vEr-2Ty_ZsQVtgVUtUH_6NwBB8dcg/pub?embedded=true"

 ...
 <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-60 h-screen pt-20 transition-transform -translate-x-full bg-blue-200 border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700 overflow-y-auto" aria-label="Sidebar">
  <div class=" px-3 pb-4 overflow-y-auto bg-blue-200 h-full dark:bg-gray-800">
     <ul class="space-y-2">
      {{-- Menu Home --}}
        <li>
           <a href="/reviu" class=" {{ ($title==="Home") ? 'flex items-center w-full p-2 text-base rounded-lg text-blue-800 transition duration-75 bg-gray-100 rounded-t-lg dark:bg-gray-500 dark:text-white font-semibold' :
        ...
        <li> 
         @php
             $satker = array('Prosedur Analitis', 'Dokumen Sumber');
         @endphp
         ...
         ">
               <li>
                  <a href="/reviu/prosedur-analitis" class="flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 group text-gray-900 dark:text-white {{ ($title==="Prosedur Analitis") ? 'bg-gray-100 dark:bg-gray-700' :' hover:bg-gray-100 dark:hover:bg-gray-700' }} ">Isi Prosedur Analitis</a>
               </li>
               <li>
                  <a href="/reviu/unggah-lk" class="flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 text-gray-900 group dark:text-white {{ ($title==="Dokumen Sumber") ? 'bg-gray-100 dark:bg-gray-700' :' hover:bg-gray-100 dark:hover:bg-gray-700' }} ">Dokumen Sumber</a>
               </li>
         </ul>
        </li>
        ...
        <li>
         ...
         ">
               <li>
                  <a href="/reviu/kertas-kerja-reviu" class="flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 group text-gray-900 dark:text-white {{ ($title==="Kertas Kerja Reviu") ? 'bg-gray-100 dark:bg-gray-700' :' hover:bg-gray-100 dark:hover:bg-gray-700' }} ">Isi Kertas Kerja Reviu</a>
               </li>
               <li>
                  <a href="/reviu/catatan-hasil-reviu" class="flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 text-gray-900 group dark:text-white {{ ($title==="Catatan Hasil Reviu") ? 'bg-gray-100 dark:bg-gray-700' :' hover:bg-gray-100 dark:hover:bg-gray-700' }} ">Catatan Hasil Reviu & Laporan Hasil Reviu</a>
               </li>
               {{-- <li>
                  <a href="/reviu/laporan-hasil-reviu" class="flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 text-gray-900 group dark:text-white {{ ($title==="Laporan Hasil Reviu") ? 'bg-gray-100 dark:bg-gray-700' :' hover:bg-gray-100 dark:hover:bg-gray-700' }} ">Laporan Hasil Reviu</a>
               </li> --}}
               <li>
                  <a href="/reviu/unggah-lhr" class="flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 text-gray-900 group dark:text-white {{ ($title==="Unggah LHR") ? 'bg-gray-100 dark:bg-gray-700' :' hover:bg-gray-100 dark:hover:bg-gray-700' }} ">Unggah LHR & CHR</a>
               </li>
         </ul>
        </li>
        ...
        <li>
         ...
         ">
               <li>
                  <a href="/reviu/kertas-kerja-tindak-lanjut" class="flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 group text-gray-900 dark:text-white {{ ($title==="Kertas Kerja Tindak Lanjut") ? 'bg-gray-100 dark:bg-gray-700' :' hover:bg-gray-100 dark:hover:bg-gray-700' }} ">Isi Kertas Kerja Tindak Lanjut</a>
               </li>
               <li>
                  <a href="/reviu/catatan-hasil-tindak-lanjut" class="flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 text-gray-900 group dark:text-white {{ ($title==="Catatan Hasil Tindak Lanjut") ? 'bg-gray-100 dark:bg-gray-700' :' hover:bg-gray-100 dark:hover:bg-gray-700' }} ">
                     Catatan Tindak Lanjut & Laporan Tindak Lanjut</a>
               </li>
               {{-- <li>
                  <a href="/reviu/laporan-hasil-tindak-lanjut" class="flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 text-gray-900 group dark:text-white {{ ($title==="Laporan Hasil Tindak Lanjut") ? 'bg-gray-100 dark:bg-gray-700' :' hover:bg-gray-100 dark:hover:bg-gray-700' }} ">Laporan Hasil Tindak Lanjut</a>
               </li> --}}
               <li>
                  <a href="/reviu/unggah-lhtl" class="flex items-center w-full p-2 text-base font-normal  transition duration-75 rounded-lg pl-11 text-gray-900 group dark:text-white {{ ($title==="Unggah LHTL") ? 'bg-gray-100 dark:bg-gray-700' :' hover:bg-gray-100 dark:hover:bg-gray-700' }} ">Unggah LTL & CTL</a>
               </li>
         </ul>
        </li>
        ...
        {{-- Menu Monitoring --}}
        <li>
         <a href="/reviu/monitoring" class=" {{ ($title==="Monitoring") ? 'flex items-center w-full p-2 text-base rounded-lg text-blue-800 transition duration-75 bg-gray-100 rounded-t-lg dark:bg-gray-500 dark:text-white font-semibold' :
         'flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700' }}
         ">
        ...
        {{-- Menu File --}}
        <li>
         <a href="/reviu/dokumen" class=" {{ ($title==="File") ? 'flex items-center w-full p-2 text-base rounded-lg text-blue-800 transition duration-75 bg-gray-100 rounded-t-lg dark:bg-gray-500 dark:text-white font-semibold' :
         'flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700' }}
         ">
